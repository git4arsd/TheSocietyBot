...
public class LoginActivity extends AppCompatActivity {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "leo@societybot.com:dicaprio", "admin@societybot.com:hollywood"
    };
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
               result = attemptLogin();
                if (result){
                    ...
                    mEmailView.setError("Your email maybe incorrect");
                    mPasswordView.setError("Your password maybe incorrect");
        ...
        signupButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast toast = Toast.makeText(loginActivity, text, duration);
                toast.show();
        ...
        //  showProgress(true);
            for (String credential : DUMMY_CREDENTIALS) {
                ...
                if (pieces[0].equals(email)) {
                    ...
                    isMatch = pieces[1].equals(password);
                }
            }
